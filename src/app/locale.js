...
const i18n = new I18n({
	en: {
		...
		'settings:export:opm:label:note':
			'This will export an un-encrypted comma-separated file which contains all your entries',
		'settings:export:label:enter-password': 'Enter your current password',
		'settings:export:note:verify-password': 'This verification is for security purposes',
		'settings:export:text:password': 'Password',
		...
		'settings:export:generated:label:generating': 'Generating your CSV file(s)',
