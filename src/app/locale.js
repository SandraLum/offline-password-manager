...
const i18n = new I18n({
	en: {
		...
		'settings:export:label:password': 'Password',

		'settings:export:opm:label:note': 'Unencrypted comma-separated file which contains all your entries',
		'settings:export:text:password': 'Enter your password to export',
		'settings:export:label:export:file-format:csv': 'CSV',
		'settings:export:label:export:file-format:opm': 'OPM',
		'settings:export:label:export:file-format': 'Please select a file format to export',
		'settings:export:button:export': 'Export Data',
		'settings:export:backup:note':
			'Encrypted backup file of your data which can only be restored in an Offline Password Manager app',
		'settings:export:generated:label:all:profiles:note': 'Select one of the following profiles for the export',
		'settings:export:generated:label:all:profiles': 'Profiles',
		'settings:export:generated:label:generating': 'Generating your files, please wait a moment',
		'settings:export:generated:loading': 'Generating your files, please wait a moment',
